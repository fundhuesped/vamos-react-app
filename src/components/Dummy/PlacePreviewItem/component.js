...
import { Text, TouchableHighlight, StyleSheet, View, Image, Dimensions } from 'react-native';
...
export default class PlacePreviewItem extends React.PureComponent {
  ...
  _onPress = () => {
    this.props.navigation.navigate('Establishment', { establishmentData: this.props.data }, ()=>{
      ...
      <TouchableHighlight
        ...
        <View style={{flexDirection:'row'}}>
          <View style={styles.placePreviewContainer}>
            <View style={[styles.placePreviewHeader, styles.rowAlign, styles.marginSeparator]}>
              <Text style={[styles.fontColor, {fontWeight:'bold',fontSize:16}]} numberOfLines={1}>{this.props.data.placeData.establecimiento}</Text>
            </View>
          ...
          <View style={{flex:1, justifyContent:'center', alignItems:'center', backgroundColor:'#e6334c', borderTopRightRadius: 5, borderBottomRightRadius: 5}}>
