...
class Evaluations extends React.Component {
  ...
  render() {
    let event = this.props.navigation.state.params.establishment.establecimiento+" "+this.props.navigation.state.params.establishment.placeId;
    tracker.trackEvent('evaluando', event);
    return (<DummyEvaluations
      navigation={this.props.navigation} servicesAvailable={this.props.navigation.state.params.servicesAvailable} establishmentId={this.props.navigation.state.params.establishment.placeId} lang={this.props.ui.lang}
