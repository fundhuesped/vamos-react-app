...
class SmartServices extends React.Component {
  ...
  render() {
    return (<DummyServices navigation={this.props.navigation} serviceTypeData={(this.props.ui.lookingFor === this.props.navigation.state.params.service) ? this.props.ui.lookingFor : CON } lang={this.props.ui.lang}/>)
  }
}
