...
describe('DB Reducer', () => {
  ...
  describe('Common cases', () => {
    it('Insert mock fetched places into store.', () => {
      let newState = DBReducer(initialState, updatePlaces({
        1: [{
          placeId: 32,
          ssr: "SI"
        }, {
      ...
      let veryNewState = DBReducer(newState, updatePlaces({
        1: [{
          placeId: 32,
          ssr: false
        }, {
      ...
      expect(Object.keys(veryNewState.places.meta.failedPages).length).toEqual(1)
    ...
    it('Insert mock fetched countries into store.', () => {
      let newState = DBReducer(initialState, updateCountries([{
          id: 1,
    ...
    it('Insert mock fetched provinces into store.', () => {
      let newState = DBReducer(initialState, updateProvinces([{
          id: 1,
    ...
    it('Insert mock fetched cities into store.', () => {
      let newState = DBReducer(initialState, updateCities([{
          id: 1,
