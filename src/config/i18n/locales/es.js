export default {
  ...
  General_ILE_VE:
    "En Venezuela el aborto está legalmente restringido. Sin embargo, puedes acceder a servicios de orientación e información integral y confidencial sobre opciones ante embarazos no deseados.",
  goToMap: "Ir a Mapa",
  goToAbout: "Acerca de",
  goToSuggest: "Sugerir",
  ...
  condones_desc:
    "Usar el condón correctamente es la única forma que te permite evitar embarazos no planificados y prevenir infecciones de transmisión sexual. Encuentra dónde conseguirlos en tu país.",
  condones_short_desc: "Encuentra dónde conseguir condones en tu país.",
  condones_content: "",
  prueba_name: "Prueba de VIH y otras ITS",
  prueba_short_desc:
    "Encuentra dónde realizar pruebas de VIH y otras Infecciones de Transmisión Sexual en tu país.",
  prueba_desc:
    "Las pruebas de VIH y otras Infecciones de Transmisión Sexual (ITS) te permiten conocer tu diagnóstico a tiempo y tomar las medidas adecuadas para tratar la infección. Encuentra dónde realizarlas en tu país.",
  prueba_content: "",
  mac_name: "Métodos anticonceptivos",
  mac_content: "",
  mac_desc:
    "Además de condones, otros métodos anticonceptivos te permiten evitar embarazos no planificados. Con ayuda de consejería, puedes elegir el método disponible más adecuado para ti. Encuentra dónde conseguirlos en tu país.",
  mac_short_desc:
    "Encuentra dónde conseguir métodos anticonceptivos en tu país.",
  ile_name: "Interrupción Legal del Embarazo",
  ile_content: "",
  ile_desc:
    "En América Latina y el Caribe, tienes derecho a acceder a consejería y/o a la interrupción legal de un embarazo bajo diferentes circunstancias. Encuentra más información sobre tu país.",
  ile_short_desc:
    "Encuentra información sobre interrupción legal del embarazo en tu país.",
  dc_name: "Detección de Cáncer",
  dc_content: "",
  dc_desc:
    "Hacerte estudios para detectar el cáncer de mama y cuello uterino de manera temprana te permite tomar las medidas adecuadas para controlarlo. Encuentra dónde realizarlos en tu país.",
  dc_short_desc:
    "Encuentra dónde realizar estudios para detectar el cáncer de mama y cuello uterino en tu país.",
  ssr_name: "Servicios de Salud Sexual y Reproductiva",
  ssr_content: "",
  ssr_desc:
    "Además de métodos anticonceptivos, otros servicios de salud sexual y reproductiva como consulta, detección y tratamiento junto con consejería para tomar decisiones informadas están disponibles a precios accesibles. Encuentra los servicios en tu país.",
  ssr_short_desc:
    "Encuentra los servicios de salud sexual y reproductiva en tu país.",
  ...
  footer_text:
    'Vamos es una plataforma <b>colaborativa.</b> Si encuentras un error en los datos o en el funcionamiento de la plataforma  <a href="mailto:vamoslacapp@gmail.com"  target="_self">envianos un mensaje</a>',
  ...
  seggest: "Sugerir",
  client_colaboration:
    "Con tu colaboración podemos hacer que la búsqueda sea más certera.",
  add: "Agregar",
  ...
  observations: "",
  form_gps_find:
    "Si actualmente te encuentras en el establecimiento haz click aquí para localizar el lugar con tu GPS",
  location: "Ubicación",
  ...
  panel_reject_place_modal_confirmation_1:
    "¿Estás seguro que deseas rechazar el siguiente lugar?",
  panel_reject_place_modal_confirmation_2:
    "Una vez rechazado, puedes volver a agregarlo de la sección Rechazados",
  no: "No",
  yes: "Si",
  ...
  panel_actives_input_placeholder_1:
    "Escribe aquí el nombre o calle del establecimiento que quieres encontrar",
  ...
  panel_actives_modal_title:
    "Elegir los servicios de las evaluaciones a exportar",
  pending: "Pendientes",
  ...
  panel_imports_disabledbutton_label:
    "Los procesos que tienen el botón de exportar deshabilitado son aquellos que sufrieron la actualización de todos sus datos originales",
  ...
  panel_detail_evaluation_filterserviceplaceholder:
    "Escribe aquí para buscar dentro de los comentarios",
  ...
  panel_detail_general_seggest:
    "¿No existe el departamento? Sugiere uno nuevo.",
  ...
  importer_confirmfastid_notfoundlabel:
    "No se encontraron datos nuevos en su dataset.",
  cancel: "Cancelar",
  confirm: "Confirmar",
  ...
  evaluation_selectservice_optionlabel:
    "Selecciona el servicio que quieres evaluar*",
  ...
  evaluation_question_12:
    "¿Qué tipo de servicio solicitaste?* (Si fue más de uno marca el principal)",
  evaluation_question_13:
    "¿Qué tan probable es que recomiendes este lugar a alguien que necesite un servicio similar?* (0 significa NADA PROBABLE y 10 significa MUY PROBABLE)",
  evaluation_question_14:
    "¿Quieres seguir en contacto con nosotr@s? Por favor, indica tus datos de contacto, tu respuesta no será publicada.",
  ...
  seo_meta_property_description_3:
    "dónde conseguir condones, métodos anticonceptivos, realizarte la prueba de VIH y otras ITS, detectar cáncer de cuello uterino y mamas, recibir consejería sobre interrupción legal del embarazo y servicios de salud sexual y reproductiva.",
  seo_meta_property_description_4:
    "Ubica dónde conseguir condones, métodos anticonceptivos, realizarte la prueba de VIH y otras ITS, detectar cáncer de cuello uterino y mamas, recibir consejería sobre interrupción legal del embarazo y servicios de salud sexual y reproductiva en",
  ...
  name: "Nombre",
  social_share_text:
    "Usando%20%23VAMOS%20busqué%20servicios%20y%20encontré%20{{establecimiento}}%20en%20{{nombre_partido}}",
  social_share_text_2:
    "Encuentra los servicios de salud sexual y reproductiva más cercanos http://ippf-staging.com.ar",
  web_url: "https://ippf-staging.com.ar",
  web_url_label: "www.ippf-staging.com.ar",
  "intro text":
    "Vamos es una plataforma colaborativa. Si encuentras un error en los datos o en el funcionamiento de la plataforma envíanos un mensaje.",
  mundo_antic_resultado:
    "<Número> lugares de entrega de métodos anticonceptivos en <Ciudad>",
  mundo_antic_sin_resultado:
    "No tenemos registrados lugares de entrega de métodos anticonceptivos en <Ciudad>",
  mundo_ile_resultado:
    "<Número> consejerías sobre Interrupción Legal del Embarazo en <Ciudad>",
  mundo_ile_sin_resultado:
    "No tenemos registradas consejerías sobre Interrupción Legal del Embarazo en <Ciudad>",
  mundo_condones_resultado:
    "<Número> lugares de entrega de condones en <ciudad>",
  mundo_condones_sin_resultado:
    "No tenemos registrados lugares de entrega de condones en <ciudad>",
  mundo_vih_resultado:
    "<Número>  lugares para la realización de pruebas de VIH y otras ITS en <ciudad>",
  mundo_vih_sin_resultado:
    "No tenemos registrados lugares para la realización de pruebas de VIH y otras ITS en <ciudad>",
  mundo_ssr_resultado:
    "<Número>  lugares para la detección de cáncer de cuello uterino y de mamas <ciudad>",
  mundo_ssr_sin_resultado:
    "No tenemos registrados lugares para la detección de cáncer de cuello uterino y de mamas en <ciudad>",
  mundo_Cáncer_sin_resultado:
    "<Número>  servicios de salud sexual y reproductiva en <ciudad>",
  mundo_Cáncer_sin_resultado:
    "No tenemos registrados servicios de salud sexual y reproductiva en <ciudad>",
  meta_landing_pais_titulo:
    '"Ubica dónde conseguir condones, métodos anticonceptivos, realizarte la prueba de VIH y otras ITS, detectar cáncer de cuello uterino y mamas, recibir consejería sobre interrupción legal del embarazo y servicios de salud sexual y reproductiva en diferentes países',
  meta_landing_pais_desc:
    "Elige los países donde conseguir condones, métodos anticonceptivos, realizarte la prueba de VIH y otras ITS, detectar cáncer de cuello uterino y mamas, recibir consejería sobre interrupción legal del embarazo y servicios de salud sexual y reproductiva",
  meta_landing_pais_og:
    '"Encuentra en {{nombre_pais}} dónde conseguir condones, métodos anticonceptivos, realizarte la prueba de VIH y otras ITS, detectar cáncer de cuello uterino y mamas, recibir consejería sobre interrupción legal del embarazo y servicios de salud sexual y reproductiva.',
  meta_landing_provincia_desc:
    '"Encuentra en {{nombre_pais}}. {{nombre_provincia}} dónde conseguir condones, métodos anticonceptivos, realizarte la prueba de VIH y otras ITS, detectar cáncer de cuello uterino y mamas, recibir consejería sobre interrupción legal del embarazo y servicios de salud sexual y reproductiva."',
  meta_landing_provincia_og:
    '"Encuentra en {{nombre_pais}}. {{nombre_provincia}} dónde conseguir condones, métodos anticonceptivos, realizarte la prueba de VIH y otras ITS, detectar cáncer de cuello uterino y mamas, recibir consejería sobre interrupción legal del embarazo y consultar en servicios de salud sexual y reproductiva."',
  meta_landing_ciudad_desc:
    '"Encuentra en {{nombre_ciudad}}  {{nombre_pais}}. {{nombre_provincia}} dónde conseguir condones, métodos anticonceptivos, realizarte la prueba de VIH y otras ITS, detectar cáncer de cuello uterino y mamas, recibir consejería sobre interrupción legal del embarazo y consultar en servicios de salud sexual y reproductiva."',
  meta_landing_ciudad_desc:
    '"Encuentra en {{nombre_ciudad}}  {{nombre_pais}}. {{nombre_provincia}} dónde conseguir condones, métodos anticonceptivos, realizarte la prueba de VIH y otras ITS, detectar cáncer de cuello uterino y mamas, recibir consejería sobre interrupción legal del embarazo y consultar en servicios de salud sexual y reproductiva."',
  condones_name_titlulo:
    "¿Dónde consigo condones en {{nombre_pais}}. {{nombre_provincia}}, [{nombre_Ciudad}}?",
  condones_name_meta:
    'Encuentra los lugares de entrega de condones en {{nombre_pais}}. {{nombre_provincia}}, [{nombre_Ciudad}}"',
  vih_name_meta:
    'Encuentra los lugares para la realización de pruebas de VIH y otras ITS en {{nombre_pais}}. {{nombre_provincia}}, [{nombre_Ciudad}}"',
  antic_name_meta:
    'Encuentra los lugares de entrega de métodos anticonceptivos en {{nombre_pais}}. {{nombre_provincia}}, [{nombre_Ciudad}}"',
  ile_name_meta:
    'Encuentra consejerías sobre Interrupción Legal del Embarazo en {{nombre_pais}}. {{nombre_provincia}}, [{nombre_Ciudad}}"',
  "Cáncer_name_ meta":
    'Encuentra los lugares para la detección de cáncer de cuello uterino y de mamas en {{nombre_pais}}. {{nombre_provincia}}, [{nombre_Ciudad}}"',
  ssr_name_meta:
    'Encuentra servicios de salud sexual y reproductiva en {{nombre_pais}}. {{nombre_provincia}}, [{nombre_Ciudad}}"',
  vih_name_titulo:
    "¿Dónde me puedo hacer la prueba de VIH y otras ITS en {{nombre_pais}}. {{nombre_provincia}}, [{nombre_Ciudad}}?",
  antic_name_titulo:
    "¿Dónde consigo anticonceptivos en {{nombre_pais}}. {{nombre_provincia}}, [{nombre_Ciudad}}?",
  ile_name_titulo:
    "¿Dónde recibo consejería sobre interrupción legal del embarazo en {{nombre_pais}}. {{nombre_provincia}}, [{nombre_Ciudad}}?",
  "Cáncer_name_ titulo":
    "¿Dónde detectan cáncer de cuello uterino y mamas en {{nombre_pais}}. {{nombre_provincia}}, [{nombre_Ciudad}}?",
  ssr_name_titulo:
    "¿Dónde hay servicios de salud sexual y reproductiva en {{nombre_pais}}. {{nombre_provincia}}, [{nombre_Ciudad}}?",
  adol_desc_short:
    "Encuentra los servicios amigables para adolescentes más cercanos.",
  adol_name: "Servicios amigables para adolescentes",
  seo_select_city: "Selecciona una Ciudad",
  there_are_xx_places:
    'Existen <strong class="orange-c"> [[count]] </strong> centros.',
  there_are_one_place: "Existe un centro.",
  there_are_no_places: "No existen centros.",
  choose_one:
    'Elige el centro en el <strong ng-click="goToMap()"> mapa </strong> o un país para ver más detalles.',
  center: "Centros",
  ...
  preCopyNotFound:
    "No se encontraron lugares para el servicio <b>[[service]]</b> en <b>[[city]]</b>",
  ...
  reload_bd_popup_content:
    "¿Estás segur@ que quieres descargar nuevamente la base de datos? Esto podría llevar un momento, te aconsejamos conectarte a una red WiFi.",
  reload_bd_popup_last_date: "Última sincronización: {{date}}",
  nearby_gps_popup_title: "GPS",
  nearby_gps_popup_content:
    "Para acceder a los establecimientos más cercanos, tienes que activar tu GPS",
  back_label_button: "Volver",
  loader_first_fetch_title: "Bienvenid@",
  loader_first_fetch_content:
    "Estamos descargando todos los establecimientos y ciudades para que puedas continuar usando la aplicación aún sin conexión a internet",
  loader_first_fetch_download_progress:
    "Descargando {{current}} establecimientos de {{total}}",
  ...
  friendly_gps_popup_content:
    "Para acceder a la búsqueda de servicios amigables para adolescentes tienes que activar tu GPS",
  search_gps_popup_title: "GPS",
  search_gps_popup_content:
    "Para acceder a la búsqueda por geolocalización tienes que activar tu GPS",
  autocomplete_not_found_result_label: "No se encontraron resultados, ",
  autocomplete_not_found_result_label_underline: "sugiere uno",
  ...
  rate_popup_content:
    "Para poder evaluar un establecimiento tienes que tener conexión a internet",
  map_popup_title: "SIN CONEXIÓN A INTERNET",
  map_popup_content:
    "Para acceder al mapa tienes que tener conexión a internet",
  ...
  success_evaluation_content:
    "Tus respuestas ayudan a que todas las personas accedamos a mejores servicios.",
  success_evaluation_aditional_info: " ",
  close_label_button: "Cerrar",
  establishments_not_found_result_label:
    "No se encontraron establecimientos cercanos",
  ...
  about_donde_description:
    "VAMOS tiene como objetivos promover el acceso a la información acerca de servicios de salud sexual y reproductiva y facilitar la participación ciudadana para mejorar la calidad de los mismos.",
  about_donde_description_2:
    "De forma rápida y sencilla puedes encontrar lugares que brindan los siguientes servicios y calificar cómo fue la atención recibida:",
  ...
  about_li_label_dc:
    "Detección temprana de cáncer de cuello uterino y cáncer de mamas",
  ...
  about_description5_add_info:
    "Para sumar otro tipo de información envíanos un ",
  ...
  noResults:
    "No tenemos registrados lugares de entrega gratuita de Condones en [[ciudad]]",
  point: "[[rate]] punto",
  social_share_text_not_encode:
    "Usando #VAMOS encontré {{establecimiento}} en {{nombre_partido}}",
  direcion_position_label: "{{calle}} {{altura}} {{piso}} y {{interseccion}}",
  evaluation_8: "Nombre:",
  evaluation_9: "Mail:",
  evaluation_10: "Télefono:",
  chat_text_middle: "Chatea con nosotros",
  chat_text_extend: "Tienes dudas? Chatea con nosotros",
  chat_text_short: "Chatea",
  terms_language: "IDIOMA",
  terms_title:
    "Para utilizar VAMOS debes leer y aceptar los Términos y Condiciones de la plataforma",
