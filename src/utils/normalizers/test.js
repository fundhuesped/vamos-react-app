...
describe('Normalizer engine: ', () => {
  ...
  it('Insert and normalize evaluation list on place works as expected', () => {
    let normalizedPlacesWithEvaluations = normalizeAndInsertEvaluationsList(normalizePlacesList({
      1: [{
        placeId: 32
      }, {
        placeId: 33
  ...
  it('Normalize places list avoid places without id', () => {
    expect(Object.keys(normalizePlacesList({
      1: [{},
        {
          placeId: 1,
          altura: "TEST"
