...
import {selectLookingFor, setCurrentLocation,selectSearchEngine} from '../../constants/actions/index.js'
                ...
                <View style={styles.row}>
                  <View style={styles.column}>
                    <TouchableHighlight
                      ...
                      onPress={()=>{this._handleOnPress(CON)}}
                      style={styles.box}
                      activeOpacity={0.5}
                      underlayColor="white"
                      >
                    ...
                    <TouchableHighlight
                      onPress={()=>{this._handleOnPress(MAC)}}
                      style={styles.box}
                      activeOpacity={0.5}
                      underlayColor="white"
                      >
                    ...
                    <TouchableHighlight
                      onPress={()=>{this._handleOnPress(DC)}}
                      style={styles.box}
                      activeOpacity={0.5}
                      underlayColor="white"
                      >
                  ...
                  <View style={styles.column}>
                    <TouchableHighlight
                      onPress={()=>{this._handleOnPress(VIH)}}
                      style={styles.box}
                      activeOpacity={0.5}
                      underlayColor="white"
                      >
                    ...
                    <TouchableHighlight
                      onPress={()=>{this._handleOnPress(LPI)}}
                      style={styles.box}
                      activeOpacity={0.5}
                      underlayColor="white"
                      >
                    ...
                    <TouchableHighlight
                      onPress={()=>{this._handleOnPress(SSR)}}
                      style={styles.box}
                      activeOpacity={0.5}
                      underlayColor="white"
                      >
                    ...
                    >
                      <View style={styles.lastboxContent}>
                        <SVGTeenIcon
                          ...
                          width={(width/7)}
                        />
                        <Text style={styles.boxContentText}>{I18n.t("friendly_service_label", {locale: this.props.ui.lang})}</Text>
                      </View>
                  </TouchableHighlight>
                </View>
                <Modal
                  ...
                  <View style={styles.modalView}>
                    ...
                    <View style={styles.modalViewDescription}>
                      <View style={styles.modalViewDescriptionIcon}>
                        ...
                        <Text style={{flex: 1, color:'#5d5d5d', fontSize: 16}}>{I18n.t("friendly_gps_popup_content", {locale: this.props.ui.lang})}</Text>
                    </View>
